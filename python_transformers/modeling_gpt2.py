...
class GPT2Model(GPT2PreTrainedModel):
    ...
    """
    def __init__(self, config, latent_size, vocab_role_size):
    ...
    def forward(self, input_ids, past=None, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None, latent_as_gpt_emb=False, latent_as_gpt_memory=True, is_role=False, role_ids=None):
        if past is None:
            past_length = 0
...
class GPT2ForLatentConnector(GPT2PreTrainedModel):
    ...
    def forward(self, input_ids, past=None, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None,
        ...
        if labels is not None:
            ...
            loss_fct = CrossEntropyLoss(ignore_index=label_ignore, reduction='none') # 50257 is the padding id, otherwise -1 is used for masked LM.
            loss = loss_fct(shift_logits.view(-1, shift_logits.size(-1)), shift_labels.long().view(-1))
