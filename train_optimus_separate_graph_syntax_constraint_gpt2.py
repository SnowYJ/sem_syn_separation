...
from optimus_separate_graph_syntax_constraint_gpt2.examples.big_ae.utils import frange_cycle_zero_linear
...
def main(args):
    ...
    fuse_way = 'fuse_syn_Q_sem_KV'

    # add_syn_Q_sem_KV
    # add_syntax_query (not low-rank)
    # fuse_syntax_query (low-rank Q)
    # fuse_syn_Q_sem_KV (low-rank QKV)

    # fuse_syntax_key
    # fuse_syntax_value
    # fuse_syntax_query_key_value
    # fuse_syntax_query_key_value_one_fuse_model
    # fuse_syntax_query_key_value_sep_head
    # fuse_syntax_query_key_value_sep_head_no_mask
    # fuse_syntax_query_key_value_sep_head_one_fuse_model
    # fuse_syntax_query_key_value_sep_head_one_fuse_model_no_mask
    ...
    include_var_graph = False if exp == 'symbol' else True # the naming is wrong, (ignore naming)
    # ----------------------------------------
