...
def load_graph_optimus(args, logger, model_encoder, tokenizer_decoder):
    ...
    model = OptimusVAE(model_encoder, model_decoder, tokenizer_decoder, args)
...
def main(args):
    ...
    model_vgae = VGraphAE(device, input_dim=args.latent_size, hidden_dim=args.latent_size, num_layers=2, sym_dict=vocab_s, heads=8, include_var=include_var, graph_type=graph_type)
